...
module.exports = function (app) {
  var Historicos_sucursales48hs = app.db.models.Historicos_sucursales48hs;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return Turnos_sucursales48hs.count({
            ...
            case 7:
              ...
              Historicos_sucursales48hs.create(historicoObj).then(function (result) {
  ...
  app.route("/historicos_sucursales48hs").get(function (req, res) {
    Historicos_sucursales48hs.findAll().then(function (result) {
    ...
    Historicos_sucursales48hs.create(req.body).then(function (result) {
      return res.json(result);
    })["catch"](function (error) {
  ...
  app.route("/historicosSucursales48hsFecha").post(function (req, res) {
